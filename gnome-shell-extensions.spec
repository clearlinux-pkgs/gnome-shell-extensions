...
Source0  : https://download.gnome.org/sources/gnome-shell-extensions/41/gnome-shell-extensions-41.1.tar.xz
...
%prep
%setup -q -n gnome-shell-extensions-41.1
cd %{_builddir}/gnome-shell-extensions-41.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639506771
...
cp %{_builddir}/gnome-shell-extensions-41.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-shell-extensions/a49ccf4ee26e90b0baa0cdd4cf2ae9bb3b0ff67d
cp %{_builddir}/gnome-shell-extensions-41.1/data/gnome-shell-sass/COPYING %{buildroot}/usr/share/package-licenses/gnome-shell-extensions/a49ccf4ee26e90b0baa0cdd4cf2ae9bb3b0ff67d
