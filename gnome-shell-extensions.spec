...
Version  : 40.2
Release  : 36
URL      : https://download.gnome.org/sources/gnome-shell-extensions/40/gnome-shell-extensions-40.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-shell-extensions/40/gnome-shell-extensions-40.2.tar.xz
...
%prep
%setup -q -n gnome-shell-extensions-40.2
cd %{_builddir}/gnome-shell-extensions-40.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623335786
...
cp %{_builddir}/gnome-shell-extensions-40.2/COPYING %{buildroot}/usr/share/package-licenses/gnome-shell-extensions/a49ccf4ee26e90b0baa0cdd4cf2ae9bb3b0ff67d
cp %{_builddir}/gnome-shell-extensions-40.2/data/gnome-shell-sass/COPYING %{buildroot}/usr/share/package-licenses/gnome-shell-extensions/a49ccf4ee26e90b0baa0cdd4cf2ae9bb3b0ff67d
