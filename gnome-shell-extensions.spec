...
Version  : 48.0
Release  : 65
URL      : https://download.gnome.org/sources/gnome-shell-extensions/48/gnome-shell-extensions-48.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-shell-extensions/48/gnome-shell-extensions-48.0.tar.xz
...
%prep
%setup -q -n gnome-shell-extensions-48.0
cd %{_builddir}/gnome-shell-extensions-48.0
pushd ..
cp -a gnome-shell-extensions-48.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742588635
