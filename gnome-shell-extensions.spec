...
Source0  : https://download.gnome.org/sources/gnome-shell-extensions/47/gnome-shell-extensions-47.4.tar.xz
...
%prep
%setup -q -n gnome-shell-extensions-47.4
cd %{_builddir}/gnome-shell-extensions-47.4
pushd ..
cp -a gnome-shell-extensions-47.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738774798
