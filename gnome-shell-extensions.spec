...
Version  : 44.0
Release  : 52
URL      : https://download.gnome.org/sources/gnome-shell-extensions/44/gnome-shell-extensions-44.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-shell-extensions/44/gnome-shell-extensions-44.0.tar.xz
...
%prep
%setup -q -n gnome-shell-extensions-44.0
cd %{_builddir}/gnome-shell-extensions-44.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679691090
...
cp %{_builddir}/gnome-shell-extensions-%{version}/data/gnome-shell-sass/COPYING %{buildroot}/usr/share/package-licenses/gnome-shell-extensions/a49ccf4ee26e90b0baa0cdd4cf2ae9bb3b0ff67d || :
