...
Version  : 47.2
Release  : 62
URL      : https://download.gnome.org/sources/gnome-shell-extensions/47/gnome-shell-extensions-47.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-shell-extensions/47/gnome-shell-extensions-47.2.tar.xz
...
%prep
%setup -q -n gnome-shell-extensions-47.2
cd %{_builddir}/gnome-shell-extensions-47.2
pushd ..
cp -a gnome-shell-extensions-47.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732644042
