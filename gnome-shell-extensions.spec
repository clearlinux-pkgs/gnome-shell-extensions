...
Source0  : https://download.gnome.org/sources/gnome-shell-extensions/40/gnome-shell-extensions-40.3.tar.xz
...
%prep
%setup -q -n gnome-shell-extensions-40.3
cd %{_builddir}/gnome-shell-extensions-40.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626186146
...
cp %{_builddir}/gnome-shell-extensions-40.3/COPYING %{buildroot}/usr/share/package-licenses/gnome-shell-extensions/a49ccf4ee26e90b0baa0cdd4cf2ae9bb3b0ff67d
cp %{_builddir}/gnome-shell-extensions-40.3/data/gnome-shell-sass/COPYING %{buildroot}/usr/share/package-licenses/gnome-shell-extensions/a49ccf4ee26e90b0baa0cdd4cf2ae9bb3b0ff67d
