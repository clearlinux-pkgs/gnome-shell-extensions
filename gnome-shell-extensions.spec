...
Version  : 45.2
Release  : 56
URL      : https://download.gnome.org/sources/gnome-shell-extensions/45/gnome-shell-extensions-45.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-shell-extensions/45/gnome-shell-extensions-45.2.tar.xz
...
%prep
%setup -q -n gnome-shell-extensions-45.2
cd %{_builddir}/gnome-shell-extensions-45.2
pushd ..
cp -a gnome-shell-extensions-45.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703274983
