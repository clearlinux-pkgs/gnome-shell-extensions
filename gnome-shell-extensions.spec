...
Source0  : https://download.gnome.org/sources/gnome-shell-extensions/42/gnome-shell-extensions-42.2.tar.xz
...
%prep
%setup -q -n gnome-shell-extensions-42.2
cd %{_builddir}/gnome-shell-extensions-42.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653928465
...
cp %{_builddir}/gnome-shell-extensions-42.2/COPYING %{buildroot}/usr/share/package-licenses/gnome-shell-extensions/a49ccf4ee26e90b0baa0cdd4cf2ae9bb3b0ff67d
cp %{_builddir}/gnome-shell-extensions-42.2/data/gnome-shell-sass/COPYING %{buildroot}/usr/share/package-licenses/gnome-shell-extensions/a49ccf4ee26e90b0baa0cdd4cf2ae9bb3b0ff67d
