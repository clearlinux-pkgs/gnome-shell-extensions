...
Source0  : https://download.gnome.org/sources/gnome-shell-extensions/48/gnome-shell-extensions-48.2.tar.xz
...
%prep
%setup -q -n gnome-shell-extensions-48.2
cd %{_builddir}/gnome-shell-extensions-48.2
pushd ..
cp -a gnome-shell-extensions-48.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748359147
