...
Source0  : https://download.gnome.org/sources/gnome-shell-extensions/43/gnome-shell-extensions-43.1.tar.xz
...
%prep
%setup -q -n gnome-shell-extensions-43.1
cd %{_builddir}/gnome-shell-extensions-43.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667861749
