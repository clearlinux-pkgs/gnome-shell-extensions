...
Source0  : https://download.gnome.org/sources/gnome-shell-extensions/45/gnome-shell-extensions-45.1.tar.xz
...
%prep
%setup -q -n gnome-shell-extensions-45.1
cd %{_builddir}/gnome-shell-extensions-45.1
pushd ..
cp -a gnome-shell-extensions-45.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698848425
